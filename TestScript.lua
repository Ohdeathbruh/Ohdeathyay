...
Invisible.MouseButton1Click:Connect(function()
	script.Parent.MouseButton1Click:Connect(function()
		game.Players.bendyinyetiyo.PlayerGui.ScreenGui.Frame.Visibleai.Visible = true
		game.Players.bendyinyetiyo.PlayerGui.ScreenGui.Frame.Invisible.Visible = false
		game.Players.bendyinyetiyo.Character.LowerTorso.Transparency = 1
		game.Players.bendyinyetiyo.Character.UpperTorso.Transparency = 1
		game.Players.bendyinyetiyo.Character.LeftHand.Transparency = 1
		game.Players.bendyinyetiyo.Character.LeftLowerArm.Transparency = 1
		game.Players.bendyinyetiyo.Character.LeftUpperArm.Transparency = 1
		game.Players.bendyinyetiyo.Character.RightUpperArm.Transparency = 1
		game.Players.bendyinyetiyo.Character.RightLowerArm.Transparency = 1
		game.Players.bendyinyetiyo.Character.RightHand.Transparency = 1
		game.Players.bendyinyetiyo.Character.Head.Transparency = 1
		game.Players.bendyinyetiyo.Character.RightUpperLeg.Transparency = 1
		game.Players.bendyinyetiyo.Character.RightLowerLeg.Transparency = 1
		game.Players.bendyinyetiyo.Character.RightFoot.Transparency = 1
		game.Players.bendyinyetiyo.Character.LeftUpperLeg.Transparency = 1
		game.Players.bendyinyetiyo.Character.LeftLowerLeg.Transparency = 1
		game.Players.bendyinyetiyo.Character.LeftFoot.Transparency = 1
		game.Players.bendyinyetiyo.Character.Head.face.Transparency = 1
		game.Players.bendyinyetiyo.Character.Head.face.Transparency = 1
	end)
